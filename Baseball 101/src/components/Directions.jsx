      ...
      <div id="directionsText" style={DIRECTION_STYLES} ref={directionsRef}>
        ...
        <div className="directionsContainer">
          ...
          <div className="text">
            ...
            Free Play page generates a random player and an unlimited number of
            games can be played. These games don't count towards the user's
            score.
          </div>
        </div>
        <br></br>
        <div className="directionsContainer">
          ...
          <br></br>
          <div className="oneTabDirection">
            c. An incorrect guess will subtract 15 points from the user's score.
          </div>
          <br></br>
          <br></br>
          <div className="text">
