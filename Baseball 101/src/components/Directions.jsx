  ...
  return ReactDom.createPortal(
    <>
      ...
      <div id="directionsText" style={DIRECTION_STYLES}>
        ...
        <br></br>
        <text>
          1. The user is initially displayed with nothing but the silhouette of
          the player's image, and their score is set to 101.
        </text>
        <br></br>
        <br></br>
        <text>
          2. The user can hit the "Hint" button at any time to be displayed with
          the next year of the player's statistics.
        </text>
        <br></br>
        <br></br>
        ...
        <div id="exampleGameplay">
          ...
          <br></br>
          <text>
            2. User hits the "Hint" button and reveals the first row; 1 point is
          ...
          <br></br>
          <text>
            4. User clicks on Aaron Judge's name and is correct! Score is locked
            in at 85 points and his name and image are revealed.
          </text>
          <br></br>
          <div>
